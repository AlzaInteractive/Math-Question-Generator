...
public class Level4FractionFindDivisorWithCoefficientAndConstant implements IQuestionFactory{
	...
	public Level4FractionFindDivisorWithCoefficientAndConstant(){
	...
	protected class ProblemSkeleton implements ISingleQuizPrimaryAttributeGenerator{
		...
		public String generateQuestion() {			
			String s = "v1 = v2 / (vcoeffVAR) + vconst";
			if (even) {
				s = "v1 = v2 / (vcoeffVAR) - vconst";
			}
