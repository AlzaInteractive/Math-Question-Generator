...
public class Level3MixedOperationA implements IQuestionFactory{
	...
	public Level3MixedOperationA(Locale loc){
		this.loc = loc;
		initStringFromLocale();
	}
	public Level3MixedOperationA(){
	...
	private void setQuestion(ProblemPattern p, int a, int b, int c, int d, MultipleChoiceQuiz q) {		
		...
		q.setSolutionSteps(
				Level3MixedOperationASolution.getSolutionSteps(
						a, b, c, d, var, p,bundleAlgebraSteps));
	}
