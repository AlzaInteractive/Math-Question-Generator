...
public class Level6QuadraticFactorizeALargerThanOne implements IQuestionFactory {

	private int numOfQuestion = 5;
	private Map<Integer, ProblemSkeleton> qMap = new HashMap<Integer, Level6QuadraticFactorizeALargerThanOne.ProblemSkeleton>();
	private Locale loc;
	private ResourceBundle bundle;
	private ResourceBundle bundleAlgebra;

	public Level6QuadraticFactorizeALargerThanOne(Locale loc) {
		this.loc = loc;
		initStringFromLocale();
	}

	public Level6QuadraticFactorizeALargerThanOne() {
