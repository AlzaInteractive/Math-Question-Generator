...
public class TriangleFindBaseLengthKnownArea implements IQuestionFactory {
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;

	public TriangleFindBaseLengthKnownArea() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}

	public TriangleFindBaseLengthKnownArea(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
	...
	public List<Quiz> generateQuizList() {
		...
		for (int i = 0; i < numq; i++) {
			...
			String question = bundle.getString("geom.shape2d.question.triangle.base.fromarea");
