...
public class TrapezoidFindHeight implements IQuestionFactory {
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;

	public TrapezoidFindHeight() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}

	public TrapezoidFindHeight(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
	...
	public List<Quiz> generateQuizList() {
		...
		for (int i = 0; i < numq; i++) {
			...
			String question = bundle.getString("geom.shape2d.question.trapezoid.height.fromarea");
