...
public class TrapezoidFindPerimeter implements IQuestionFactory{
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;
	
	public TrapezoidFindPerimeter() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}
	
	public TrapezoidFindPerimeter(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
	...
	public List<Quiz> generateQuizList() {
		...
		for (int i=0;i<numq;i++){
			...
			shp.setShowLeftSlopeValue(true);
			shp.setShowRightSlopeValue(true);
