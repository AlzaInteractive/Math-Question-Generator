...
public class CircleFindPerimeterKnownRadius implements IQuestionFactory{
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;
	
	public CircleFindPerimeterKnownRadius() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}
	
	public CircleFindPerimeterKnownRadius(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
