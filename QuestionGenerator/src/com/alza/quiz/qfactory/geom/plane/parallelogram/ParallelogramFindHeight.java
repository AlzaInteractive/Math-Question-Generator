package com.alza.quiz.qfactory.geom.plane.parallelogram;
...
public class ParallelogramFindHeight implements IQuestionFactory {
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;

	public ParallelogramFindHeight() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}

	public ParallelogramFindHeight(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
	...
	public List<Quiz> generateQuizList() {
		...
		for (int i = 0; i < numq; i++) {
			...
			String question = bundle.getString("geom.shape2d.question.parallelogram.height.fromarea");
