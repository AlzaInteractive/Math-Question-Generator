package com.alza.quiz.qfactory.geom.plane.rhombus;
...
public class RhombusFindArea implements IQuestionFactory {
	private int numq = 2;
	Locale loc;
	ResourceBundle bundle;

	public RhombusFindArea() {
		this.loc = new Locale("in", "ID");
		initStringFromLocale();
	}

	public RhombusFindArea(Locale loc) {
		super();
		this.loc = loc;
		initStringFromLocale();
	}
	...
	public List<Quiz> generateQuizList() {
		...
		for (int i = 0; i < numq; i++) {
			Rhombus shp = (Rhombus) new Rhombus().createExample();
